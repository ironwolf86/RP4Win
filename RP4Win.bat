...
SET rp4winversion=0.9beta
SET lastMod="March 26, 2022"
...
GOTO CusInstall
:PullCusDir
::Pulls the custom install directory string from a custom install text file.
SET /P rp4winDir=<"%APPDATA%\RP4Win\CusInstallDir.txt"
::Pulls the custom rom directory string from a custom install text file.
IF EXIST "%APPDATA%\RP4Win\CusRomDir.txt" SET /P cusromdir=<"%APPDATA%\RP4Win\CusRomDir.txt"
GOTO CheckRP4Win
:CusInstall
...
IF NOT EXIST %rp4winDir%\ROMS\ MKDIR "%rp4winDir%\ROMS"
...
SET systemsDir=%rp4winDir%\Emulators
SET romsDir=%rp4winDir%\ROMS
...
%toolsDir%\7za\7za.exe x "%tempDir%\Wget.zip" -o"%toolsDir%\Wget" >NUL
echo =
echo =
echo =
echo =
...
::Unzip downloaded file to the Tools directory
%toolsDir%\7za\7za.exe x "%tempDir%\git.exe" -o"%toolsDir%\git" >NUL
echo =
echo =
echo =
echo =
...
%toolsDir%\7za\7za.exe x "%tempDir%\ESCheck\tempES.zip" -o"%tempDir%\ESCheck" >NUL
...
IF EXIST "C:\Users\Public\Desktop\RP4Win.lnk" DEL "C:\Users\Public\Desktop\RP4Win.lnk"
IF EXIST "C:\Users\Public\Desktop\RP4Win Windowed.lnk" DEL "C:\Users\Public\Desktop\RP4Win Windowed.lnk"
...
echo sLinkFile = "C:\Users\Public\Desktop\RP4Win.lnk">>"%tempDir%\CreateShortcut.vbs"
...
echo sLinkFile = "C:\Users\Public\Desktop\RP4Win Windowed.lnk">>"%tempDir%\CreateShortcut2.vbs"
...
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:::                                                                                               :::
:::   Generates  '^<path^>%romsDir%\...'  for ROMS path  in es_systems.cfg                     :::
:::                                                                                               :::
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

echo ^<?xml version="1.0"?^> > "%esDir%\.emulationstation\es_systems.cfg"
echo ^<systemList^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--                                                  --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  Note that some lines in this config file        --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  are commented out as intended.                  --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--                                                  --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  Learn and edit them as needed.                  --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--                                                  --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  START - ARCADE   ARCADE   ARCADE   ARCADE       --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Arcade - MAME Libretro - latest^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\mame-libretro^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\mame_VERSION\ "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>mame-libretro^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>mame^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>arcade^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>mame-libretro^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>fbneo-libretro^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - FB Neo Libretro - latest^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\fbneo-libretro^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .fba .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\fbneo_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\fbneo\fbneo.exe -rompath %romsDir%\fbneo_VERSION\ "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>fbneo-libretro^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>fbneo^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>arcade^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>fbneo-libretro^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>daphne^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - Hypseus - LaserDisc Games (Daphne/Singe)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\daphne^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.daphne^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Hypseus-Singe\hypseuse.exe "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\Daphne\daphne.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\daphne_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>atomiswave^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - Sammy AtomisWave^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\atomiswave^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.cdi .chd .gdi .lst .zip .7z^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\flycast_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>atomiswave^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>atomiswave^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>hikaru^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - Sega Hikaru^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\hikaru-demul^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.7z .zip^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Demul\demul.exe -run=hikaru -rom="%%BASENAME%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\flycast_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>hikaru^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>hikaru^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>naomi^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - Sega NAOMI^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\naomi^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.cdi .chd .gdi .lst .zip .7z^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\flycast_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>naomi^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>naomi^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>vector-games^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - Vector Games^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\vector-games^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\mame\ "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>vector-games^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>vector^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>mame^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>arcade^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>mame-libretro^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  END  -  ARCADE   ARCADE   ARCADE   ARCADE       --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  START   -   Console   Console    Console        --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Atari 2600 - (1977-1992)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\atari2600^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .a26 .bin .gz .rom .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\stella_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\stella2014_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Atari 7800 ProSystem - (1986-1992)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\atari7800^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .a78 .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>channelf^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Channel F - (1976-1983)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\channelf^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\freechaf_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\channelf\ channelf -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll channelf -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>channelf^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>channelf^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>gx4000^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GX4000 - Europe - (1990-1991)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\gx4000^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .cpr .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\gx4000\ gx4000 -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\cap32_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gx4000^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gx4000^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>mastersystem^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Master System - (1986-1992)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\mastersystem^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .sms .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>mastersystem-usa-batocera^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>megadrive^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Mega Drive Genesis - (1989-1997)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\megadrive^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .gen .md .sg .smd .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>megadrive^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>genesis^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>megadrive^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>genesis-usa-batocera^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>n64^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Nintendo 64 - (1996-2002)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\n64^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .n64 .v64 .z64 .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mupen64plus_next_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Neo*Geo (AES/MVS) - (1990-2004)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\neogeo^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.zip .7z^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\fbneo_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>NES - (1985-1995)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\nes^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .nes .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>nes-usa-batocera^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>pcengine^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PC Engine TurboGrafx 16 - (1989-1994)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\pcengine^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .pce .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_pce_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>tg16^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>tg16-usa-batocera^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>turbografx-16^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>pv1000^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PV-1000 - Japan - (1983-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\pv1000^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\pv1000\ pv1000 -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pv1000^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>pv1000^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>sg1000^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>SG-1000 - Japan - (1983-1985)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\sg1000^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .sg .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>sg1000^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>sg-1000^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>sg1000^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>snes^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Super NES - (1991-1999)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\snes^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .bs .fig .mgd .sfc .smc .swc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\snes9x_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>snes-usa-batocera^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>supergrafx^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>SuperGrafx - Japan - (1989-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\supergrafx^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .cue .chd .pce .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_pce_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_supergrafx_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>supergrafx^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>supergrafx^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>sgfx^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>supracan^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Super A`can - Taiwan - (1995)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\supracan^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\supracan\ supracan -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>supracan^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>supracan^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>super-acan^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"



echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  END   -   Console    Console    Console         --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  START   -   Console - Keypad                    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"



echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>arcadia^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcadia 2001 - (1982-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\arcadia^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\arcadia\ arcadia -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>arcadia^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>arcadia^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>astrocde^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Astrocade - (1978-1983)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\astrocade^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\astrocde\ astrocde -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>astrocade^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>astrocade^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>astrocde^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>atari5200^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Atari 5200 - (1982-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\atari5200^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .a52 .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>colecovision^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>ColecoVision - (1982-1985)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\colecovision^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .col .rom .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>coleco^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>intellivision^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Intellivision - (1979-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\intellivision^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .int .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\freeintv_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>intellivision-jzintv^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Intellivision - jzInTV - (1979-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\intellivision-jzintv^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .int .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\jzIntv\bin\jzIntv.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>intellivision-jzintv^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>intellivision-jzintv^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>intellivision^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>intellivision-voice^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>IntelliVoice - Intellivision - (1982-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\intellivision-voice^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .int .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\jzIntv\bin\jzIntv.exe -z720x480 "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>intellivision-voice^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>intellivision-voice^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>intellivision^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>intellivision-ecs^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>ECS Computer Module - Intellivision - (1983-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\intellivision-ecs^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .int .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\jzIntv\bin\jzIntv.exe -z720x480 "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>intellivision-ecs^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>intellivision-ecs^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>intellivision^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>jaguar^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Atari Jaguar - (1993-1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\jaguar^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .j64 .jag .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<platform^>jaguar^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>atarijaguar^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>jaguar^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>scv^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Super Cassette Vision - Japan - (1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\scv^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\scv\ scv -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>scv^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>scv^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>supercassettevision^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>studio2^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>RCA Studio II - (1977-1978)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\studio2^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .st2 .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\studio2\ studio2 -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>studio2^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>studio2^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>rca-studio-ii^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"



echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  END    -    Console - Keypad                    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  START   -   Console - Addon                     --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"



echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>atari2600-supercharger^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Atari 2600 - Starpath Supercharger - (1982-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\atari2600-supercharger^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .a26 .bin .gz .rom .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\stella_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\stella2014_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>atari2600-supercharger^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>atari2600-supercharger^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>atari2600^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg" 
...
echo     ^<fullname^>Famicom Disk System - Japan - (1986-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\fds^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .fds .nes .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\fceumm_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>jaguarcd^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Atari Jaguar CD - (1995-1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\jaguarcd^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .chd .cue .iso .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\virtualjaguar_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>jaguarcd^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>atarijaguarcd^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>jaguarcd^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>n64dd^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Nintendo 64DD - Japan - (1999-2001)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\n64dd^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .d64 .ndd .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\parallel_n64_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mupen64plus_next_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>n64dd^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>n64dd^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>satellaview^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Satellaview - Japan - (1995-2000)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\satellaview^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bs .sfc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\snes9x_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>Satellaview^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>satellaview^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>sega32x^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Sega 32X - (1994-1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\sega32x^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .32x .bin .md .smd .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>sufami^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Sufami Turbo - Japan - (1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\sufami^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .sfc .st .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\snes9x_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>sufami^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>sufami^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>supergb^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Super Game Boy - (1994)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\supergb^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .gb .gbc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mgba_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>supergb^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>sgb^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>supergb^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"



echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  END    -    Console - Addon        Console - Addon   --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  START   -   Console - Optical                   --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>3DO - (1993-1997)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\3do^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .iso^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\opera_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>amigacd32^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Amiga CD32 - Europe - (1993-1994)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\amigacd32^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cue .iso .lha^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\puae_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<![CDATA[ ^<command^>%systemsDir%\FS-UAE\System\FS-UAE\Windows\x86-64\fs-uae.exe --amiga-model=CD32 --joystick-port-0-mode="cd32 gamepad" --fullscreen=1 --cdrom-drive-0="%%ROM_RAW%%"^</command^> ]]^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>amigacd32^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>amigacd32^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>amigacdtv^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Commodore CDTV - (1991)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\amigacdtv^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cue^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\puae_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<![CDATA[ ^<command^>%systemsDir%\FS-UAE\System\FS-UAE\Windows\x86-64\fs-uae.exe --amiga-model=CDTV --joystick-port-0-mode=joystick --fullscreen=1 --cdrom-drive-0="%%ROM_RAW%%"^</command^> ]]^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>amigacdtv^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>amigacdtv^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>cdtv^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>cdimono1^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Philips CD-i - (1990-1998)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\cdimono1^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\cdimono1\ cdimono1 -skip_gameinfo "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>cdimono1^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>philipscdi^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>cdimono1^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>dreamcast^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Dreamcast - (1999-2001)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\dreamcast^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.cdi .chd .gdi .zip .7z^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\flycast_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>gamecube^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameCube - (2001-2007)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\gamecube^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .gcz .iso .rpx .rvz .wad .wbfs^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\dolphin_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Dolphin\Dolphin.exe -e "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Dolphin-dev\Dolphin.exe -e "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gamecube^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gamecube^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>gc^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^>  >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>neogeocd^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Neo*Geo CD - (1996-1997)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\neogeocd^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cue^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\neocd_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<![CDATA[ ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\fbneo_libretro.dll --subsystem neocd "%%ROM_RAW%%"^</command^> ]]^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>neogeocd^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>neogeocd^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>neocdz^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>neogeo-cd^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>pcenginecd^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PC Engine TurboGrafx CD - (1989-1994)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\pcenginecd^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .cue .chd .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_pce_fast_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_pce_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pcenginecd^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>pcenginecd^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>tg16cd^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>tg16cd-usa-batocera^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>turbografx-cd^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>pcfx^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PC-FX - Japan - (1994-1998)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\pcfx^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .chd .cue .img .iso .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_pcfx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pcfx^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>pcfx^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>ps2^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PlayStation 2 - (2000-2013)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\ps2^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .gz .img .iso^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\pcsx2_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\play_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<![CDATA[ ^<command^>%systemsDir%\PCSX2\pcsx2.exe "%%ROM_RAW%%" --fullscreen^</command^> ]]^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<![CDATA[ ^<command^>%systemsDir%\PCSX2-dev\pcsx2.exe "%%ROM_RAW%%" --fullscreen^</command^> ]]^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>ps3^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PlayStation 3 - (2006-2017)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\ps3^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>ps3^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>ps3^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>psx^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PlayStation - (1995-2006)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\psx^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cue .iso^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_psx_hw_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Saturn - (1995-2000)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\saturn^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cue .iso .mdf^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\kronos_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Sega CD - (1992-1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Wii - (2006-2013)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Wii U - (2012-2017)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\wiiu^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.iso .rpx .wud .wux^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>xbox^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>XBOX - (2001-2009)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\xbox^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.iso^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\Xemu\xemu.exe -full-screen -dvd_path "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>xbox^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>xbox^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^>  >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>xbox360^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>XBOX 360 - (2005-2016)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\xbox360^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.iso^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\Xenia\xenia.exe --vsync=false "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>xbox360^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>xbox360^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^>  >> "%esDir%\.emulationstation\es_systems.cfg"



echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  END    -    Console - Optical    Console - Optical   --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  START    -    Portable      Portable      Portable   --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"



echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>3ds^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>3DS - (2011-2020)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\3ds^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .3ds .cia .cxi .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\citra_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>3ds^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>3ds^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>advision^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Adventure Vision - (1982-1983)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\advision^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath  %romsDir%\advision\ advision -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg" 
echo     ^<platform^>advision^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>advision^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>adventurevision^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>gamecom^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Game.com - (1997-2000)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\gamecom^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .tgc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\gamecom\ gamecom -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gamecom^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gamecom^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>tigergame^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>gamegear^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Game Gear - (1991-2000)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\gamegear^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .gg .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Game Boy - (1989-2003)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\gb^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .gb .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Game Boy Color - (1998-2003)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\gbc^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .gbc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\gambatte_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Game Boy Advance - (2001-2010)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\gba^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .gba .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mgba_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Game ^& Watch - (1980-1991)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\gameandwatch^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.mgw^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>gw^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>gmaster^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Game Master - Europe - (1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\gmaster^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\gmaster\ gmaster -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gmaster^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gmaster^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>gp32^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Gamepark GP32 - Korea - (2001-2005)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\gp32^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .smc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\gp32\ gp32 -memc "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\GeePee32\geepee32.exe "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gp32^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gp32^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>lynx^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Atari Lynx - (1989-1995)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\lynx^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .lnx .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_lynx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\handy_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>lynx^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>atarilynx^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>lynx^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>megaduck^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Mega Duck - (1993)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\megaduck^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\megaduck\ gb -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>megaduck^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>megaduck^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>nds^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Nintendo DS - (2004-2013)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\nds^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .nds .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\desmume_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Neo*Geo Pocket - Japan/Europe - (1998-1999)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\ngp^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .ngp .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Neo*Geo Pocket Color - (1999-2001)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\ngpc^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .ngc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_ngp_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>pokemini^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Pokemon Mini - (2001-2002)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\pokemini^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .min .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\pokemonmini_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pokemini^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>pokemini^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>psp^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PSP - (2005-2014)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\psp^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cso .iso .pbp^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>pspminis^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PSP Go minis - (2009-2013)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\pspminis^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cso .iso .pbp^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\ppsspp_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pspminis^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>pspgo^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>pspminis^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>psvita^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PS Vita - (2011-2019)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\psvita^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.vpk^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\Vita3k\vita3k.exe --vpk-path "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>psvita^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>psvita^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>supervision^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Supervision - (1992)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\supervision^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .sv .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\potator_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\supervision\ svision -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>svision^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>supervision^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>svision^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>switch^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Switch - (2017-)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\switch^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.nsp .xci^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\Yuzu\yuzu.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>switch^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>switch^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^>  >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>vectrex^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Vectrex - (1982-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\vectrex^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .gam .vec .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Virtual Boy - (1995-1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\virtualboy^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .vb .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_vb_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>wswan^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>WonderSwan - Japan - (1999-2003)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\wswan^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .ws .wsc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_wswan_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>wswan^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>wonderswan^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>wswanc^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>WonderSwan Color - Japan - (2000-2003)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\wswanc^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .ws .wsc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_wswan_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>wswanc^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>wonderswancolor^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"



echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  END     -     Portable      Portable            --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  START  -   GAME ENGINE   GAME ENGINE            --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>lowresnx^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - LowRes NX - libretro - (2016)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\lowresnx^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.nx .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\lowresnx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>lowresnx^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>lowresnx^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>lutro^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - Lutro - libretro - (2016)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\lutro^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.lutro^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\lutro_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>lutro^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>lutro^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>openbor^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - OpenBOR - libretro - (2016)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\openbor^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.pak^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\OpenBOR\openbor-start.bat "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>openbor^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>openbor^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>pico8^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - PICO-8 - libretro - (2016)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\pico8^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.sh .p8 .png .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\pico8_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pico8^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>pico8^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>ports^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - Game Ports for RetroArch - libretro ^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\ports^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>ports^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>ports^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>scummvm^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - ScummVM - (2001)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\scummvm^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.exe^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\scummvm_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>scummvm^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>scummvm^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"

echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>solarus^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - Solarus (2019)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\solarus^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.solarus .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\SolarusPak\solarus\solarus-run.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>solarus^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>solarus^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>tic80^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - TIC-80 tiny computer - (2017)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\tic80^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .tic .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\tic80_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>tic80^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>tic80^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"



echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  END  -   GAME ENGINE    GAME ENGINE             --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  START  -  COMPUTER  COMPUTER   COMPUTER         --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  ********************************************    --^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>adam^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Coleco ADAM - (1983-1985)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\adam^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .col .rom .ddp .dsk .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\bluemsx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>adam^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>adam^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>amiga^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Commodore Amiga - (1985-1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\amiga^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.adf .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\puae_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Computer - Amstrad CPC - Europe - (1984-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\amstradcpc^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .cdt .cpc .dsk^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\cap32_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Computer - Apple II - (1977-1979)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\apple2^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .dsk^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\AppleWin\Applewin.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>aquarius^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Mattel Aquarius - (1983)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\aquarius^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .bin^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\aquarius\ aquarius -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>aquarius^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>aquarius^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>atari800^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Atari 800 - (1979-1992)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\atari800^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .bas .bin .car .com .xex .atr .xfd .dcm .atr.gz .xfd.gz^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\atari800_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Computer - Atari ST - (1985-1993)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\atarist^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .st .stx .img .rom .raw .ipf .ctr^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\hatari_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Hatari\Hatari.exe "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Hatari-latest\Hatari.exe "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Computer - Acorn BBC Micro, Electron - UK - (1981-1994)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\bbcmicro^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .ssd .dsd .ad .img^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\BeebEm\BeebEm.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll bbcb -cass OR -flop "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\bbcmicro\ bbcb -cass OR -flop "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>electron^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>c64^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Commodore 64 - (1982-1994)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\c64^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .crt .d64 .g64 .t64 .tap .x64 .zip .prg^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\vice_x64_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>Computer - Tandy Color / Dragon 32 - (1980-1991)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\coco^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .cas .wav .bas .asc .dmk .jvc .os9 .dsk .vdk .rom .ccc .sna^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>crvision^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - VTech CreatiVision - Europe - (1982-1986)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\crvision^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\crvision\ crvision -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>crvision^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>creativision^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>crvision^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>macintosh^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Apple Macintosh, OS 7.5.2 thru 9.0.4^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\macintosh^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .dsk .img .rom^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo ^<!-- START:  THIS  IS  WORK  IN  PROGRESS  --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\SheepShaver\sheepshaver.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\BasiliskII\basiliskii.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\MinivMac\minivmac.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo ^<!-- END:  THIS  IS  WORK  IN  PROGRESS  --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>macintosh^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>macintosh^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>msx^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Microsoft MSX, MSX2, MSX2+, MSX turboR - (1983-1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\msx^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .rom .mx1 .mx2 .col .dsk .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\bluemsx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>odyssey2^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Magnavox Odyssey 2, Videopac, Videopac+ - (1978-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\odyssey2^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\o2em_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>odyssey2^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>odyssey2^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>videopac^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>videopacplus^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>sc-3000^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Sega SC-3000 - Japan - (1983-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\sc-3000^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .sg^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>sc-3000^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>sc-3000^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>svi318^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - SVI SpectraVideo 318 - (1983-1988)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\svi318^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bas .bin .col .com .ddp .dsk .img .lbr .rom .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\bluemsx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>svi318^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>svi318^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>spectravideo^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>ti99_4a^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Texas Inst. TI-99/4A - (1981-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\ti99_4a^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.zip .bin^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\ti99_4a\ ti99_4a -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Classic99\classic99.exe -rom "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>ti99_4a^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>ti99^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>ti99_4a^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>vic20^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Commodore VIC-20 - (1980-1985)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\vic20^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .crt .d64 .g64 .t64 .tap .x64 .zip .prg^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\vice_xvic_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\WinVICE\x64.exe -fullscreen "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>vic20^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>vic20^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>x1^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Sharp X1 - Japan - (1982-1988)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\x1^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .d88 .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\x1_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %romsDir%\x1\ x1 -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll x1 -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>x1^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>x1^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>x68000^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Sharp X68000 - Japan - (1987-1993)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\x68000^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .dim .m3u .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\px68k_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>x68000^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>x68000^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>zx81^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Sinclair Z81 - UK - (1981-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\zx81^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .sh .sna .szx .z80 .tap .tzx .gz .udi .mgt .img .trd .scl .dsk .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\81_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>zx81^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>zx81^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>zxspectrum^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Sinclair ZX Spectrum - UK - (1982-1992)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<!--  **************************************************   --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  END   -   COMPUTER  COMPUTER   COMPUTER  COMPUTER    --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  **************************************************   --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo   ^<!--  **************************************************   --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  START   -   Specialty     Specialty      Specialty   --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  **************************************************   --^> >> "%esDir%\.emulationstation\es_systems.cfg"



echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>dosbox^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Specialty - DOSBox - (2002)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\dosbox^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.exe^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\dosbox_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>dosbox^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>dosbox^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>windows^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Specialty - Windows - (2002)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\windows^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.exe^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\zzz_windows_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>windows^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>windows^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>snes-msu1^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Specialty - Super NES - MSU-1 (May 2012)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\snes-msu1^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.msu .sfc^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\snes9x_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>msu1^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>snesmsu1^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"


echo   ^<system^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<name^>uzebox^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Specialty -  Uzebox - (2007)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%romsDir%\uzebox^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .uze .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\uzem_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>uzebox^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>uzebox^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"



echo   ^<!--  **************************************************   --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  END    -    Specialty     Specialty      Specialty   --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^<!--  **************************************************   --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:::                                                                                            :::
:::   End of  '^<path^>%romsDir%\...'  for ROMS path  in es_systems.cfg                        :::
:::                                                                                            :::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
IF EXIST "%APPDATA%\RP4Win\CusRomDir.txt" echo =    (custom %cusromdir%)
...
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:::                                                                                               :::
:::   Generates  '^<path^>%cusromdir%\...'  for ROMS path  in es_systems.cfg                     :::
:::                                                                                               :::
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
echo     ^<name^>mame-libretro^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - MAME Libretro - latest^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\mame-libretro^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\mame-libretro\ "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>mame-libretro^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>mame^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>arcade^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>mame-libretro^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>fbneo-libretro^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - FB Neo Libretro - latest^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\fbneo-libretro^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .fba .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\fbneo_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\fbneo\fbneo.exe -rompath %cusromdir%\fbneo-libretro\ "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>fbneo-libretro^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>fbneo^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>arcade^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>fbneo-libretro^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>atomiswave^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - Sammy AtomisWave^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\atomiswave^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.cdi .chd .gdi .lst .zip .7z^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\flycast_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>atomiswave^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>atomiswave^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>hikaru^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - Sega Hikaru^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\hikaru-demul^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.7z .zip^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Demul\demul.exe -run=hikaru -rom="%%BASENAME%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>vector-games^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - Vector Games^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\vector-games^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\vector-games\ "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>vector-games^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>vector^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>mame^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>arcade^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>channelf^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Channel F - (1976-1983)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\channelf^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\freechaf_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\channelf\ channelf -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll channelf -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>channelf^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>channelf^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>gx4000^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GX4000 - Europe - (1990-1991)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\gx4000^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .cpr .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\gx4000\ gx4000 -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\cap32_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gx4000^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gx4000^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>pv1000^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PV-1000 - Japan - (1983-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\pv1000^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\pv1000\ pv1000 -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pv1000^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>pv1000^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>sg1000^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>SG-1000 - Japan - (1983-1985)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\sg1000^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .sg .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>sg1000^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>sg-1000^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>supergrafx^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>SuperGrafx - Japan - (1989-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\supergrafx^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .cue .chd .pce .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_pce_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_supergrafx_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>supergrafx^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>supracan^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Super A`can - Taiwan - (1995)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\supracan^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\supracan\ supracan -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>supracan^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>supracan^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>super-acan^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>arcadia^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcadia 2001 - (1982-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\arcadia^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\arcadia\ arcadia -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>arcadia^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>arcadia^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>astrocde^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Astrocade - (1978-1983)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\astrocade^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\astrocde\ astrocde -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>astrocade^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>astrocade^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>astrocde^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>intellivision-jzintv^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Intellivision - jzInTV - (1979-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\intellivision-jzintv^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .int .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\jzIntv\bin\jzIntv.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>intellivision-jzintv^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>intellivision-jzintv^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>intellivision-voice^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>IntelliVoice - Intellivision - (1982-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\intellivision-voice^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .int .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\jzIntv\bin\jzIntv.exe -z720x480 "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>intellivision-voice^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>intellivision-voice^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>intellivision-ecs^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>ECS Computer Module - Intellivision - (1983-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\intellivision-ecs^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .int .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\jzIntv\bin\jzIntv.exe -z720x480 "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>intellivision-ecs^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>intellivision-ecs^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>jaguar^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Atari Jaguar - (1993-1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\jaguar^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .j64 .jag .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\virtualjaguar_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>jaguar^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>atarijaguar^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>scv^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Super Cassette Vision - Japan - (1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\scv^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\scv\ scv -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>scv^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>scv^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>supercassettevision^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>studio2^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>RCA Studio II - (1977-1978)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\studio2^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .st2 .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\studio2\ studio2 -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>studio2^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>studio2^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>rca-studio-ii^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>atari2600-supercharger^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Atari 2600 - Starpath Supercharger - (1982-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\atari2600-supercharger^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .a26 .bin .gz .rom .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\stella_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\stella2014_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>atari2600-supercharger^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>jaguarcd^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Atari Jaguar CD - (1995-1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\jaguarcd^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .chd .cue .iso .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\virtualjaguar_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>satellaview^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Satellaview - Japan - (1995-2000)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\satellaview^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bs .sfc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\snes9x_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>Satellaview^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>satellaview^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>sufami^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Sufami Turbo - Japan - (1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\sufami^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .sfc .st .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\snes9x_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>sufami^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>sufami^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>supergb^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Super Game Boy - (1994)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\supergb^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .gb .gbc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mgba_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>supergb^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>sgb^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>amigacd32^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Amiga CD32 - Europe - (1993-1994)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\amigacd32^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cue .iso .lha^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\puae_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<![CDATA[ ^<command^>%systemsDir%\FS-UAE\System\FS-UAE\Windows\x86-64\fs-uae.exe --amiga-model=CD32 --joystick-port-0-mode="cd32 gamepad" --fullscreen=1 --cdrom-drive-0="%%ROM_RAW%%"^</command^> ]]^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>amigacd32^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>amigacdtv^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Commodore CDTV - (1991)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\amigacdtv^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cue^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\puae_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<![CDATA[ ^<command^>%systemsDir%\FS-UAE\System\FS-UAE\Windows\x86-64\fs-uae.exe --amiga-model=CDTV --joystick-port-0-mode=joystick --fullscreen=1 --cdrom-drive-0="%%ROM_RAW%%"^</command^> ]]^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>amigacdtv^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>cdimono1^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Philips CD-i - (1990-1998)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\cdimono1^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\cdimono1\ cdimono1 -skip_gameinfo "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>cdimono1^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>philipscdi^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>cdimono1^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>gamecube^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameCube - (2001-2007)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\gamecube^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .gcz .iso .rpx .rvz .wad .wbfs^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\dolphin_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Dolphin\Dolphin.exe -e "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Dolphin-dev\Dolphin.exe -e "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>pcenginecd^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PC Engine TurboGrafx CD - (1989-1994)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\pcenginecd^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .cue .chd .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_pce_fast_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_pce_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pcenginecd^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>pcfx^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PC-FX - Japan - (1994-1998)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\pcfx^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .chd .cue .img .iso .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_pcfx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pcfx^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>pcfx^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>ps3^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PlayStation 3 - (2006-2017)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\ps3^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>ps3^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>ps3^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>xbox^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>XBOX - (2001-2009)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\xbox^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.iso^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\Xemu\xemu.exe -full-screen -dvd_path "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>xbox360^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>XBOX 360 - (2005-2016)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\xbox360^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.iso^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\Xenia\xenia.exe --vsync=false "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>3ds^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>3DS - (2011-2020)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\3ds^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .3ds .cia .cxi .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\citra_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>3ds^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>3ds^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>advision^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Adventure Vision - (1982-1983)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\advision^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath  %cusromdir%\advision\ advision -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg" 
echo     ^<platform^>advision^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>advision^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>adventurevision^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>gamecom^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Game.com - (1997-2000)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\gamecom^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .tgc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\gamecom\ gamecom -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gamecom^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gamecom^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>tigergame^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>gmaster^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Game Master - Europe - (1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\gmaster^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\gmaster\ gmaster -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gmaster^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gmaster^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>gp32^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Gamepark GP32 - Korea - (2001-2005)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\gp32^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .smc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\gp32\ gp32 -memc "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\GeePee32\geepee32.exe "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gp32^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gp32^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>lynx^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Atari Lynx - (1989-1995)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\lynx^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .lnx .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_lynx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\handy_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>lynx^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>megaduck^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Mega Duck - (1993)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\megaduck^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\megaduck\ gb -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>megaduck^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>megaduck^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>pokemini^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Pokemon Mini - (2001-2002)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\pokemini^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .min .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\pokemonmini_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pokemini^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>pokemini^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>pspminis^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PSP Go minis - (2009-2013)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\pspminis^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cso .iso .pbp^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\ppsspp_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pspminis^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>pspgo^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>psvita^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PS Vita - (2011-2019)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\psvita^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.vpk^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\Vita3k\vita3k.exe --vpk-path "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>psvita^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>psvita^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>supervision^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Supervision - (1992)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\supervision^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .sv .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\potator_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\supervision\ svision -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>svision^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>supervision^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>svision^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>switch^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Switch - (2017-)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\switch^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.nsp .xci^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\Yuzu\yuzu.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>wswan^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>WonderSwan - Japan - (1999-2003)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\wswan^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .ws .wsc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_wswan_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>wswan^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>wonderswan^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>wswanc^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>WonderSwan Color - Japan - (2000-2003)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\wswanc^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .ws .wsc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_wswan_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>wswanc^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>wonderswancolor^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>lowresnx^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - LowRes NX - libretro - (2016)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\lowresnx^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.nx .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\lowresnx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>lowresnx^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>lowresnx^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>lutro^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - Lutro - libretro - (2016)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\lutro^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.lutro^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\lutro_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>lutro^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>lutro^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>openbor^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - OpenBOR - libretro - (2016)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\openbor^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.pak^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\OpenBOR\openbor-start.bat "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>pico8^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - PICO-8 - libretro - (2016)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\pico8^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.sh .p8 .png .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\pico8_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pico8^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>pico8^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>ports^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - Game Ports for RetroArch - libretro ^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\ports^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>ports^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>ports^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>scummvm^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - ScummVM - (2001)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\scummvm^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.exe^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\scummvm_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>solarus^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - Solarus (2019)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\solarus^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.solarus .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\SolarusPak\solarus\solarus-run.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>tic80^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - TIC-80 tiny computer - (2017)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\tic80^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .tic .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\tic80_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>tic80^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>tic80^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>adam^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Coleco ADAM - (1983-1985)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\adam^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .col .rom .ddp .dsk .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\bluemsx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>adam^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>adam^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>aquarius^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Mattel Aquarius - (1983)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\aquarius^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .bin^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\aquarius\ aquarius -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>aquarius^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>aquarius^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>bbcmicro^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Acorn BBC Micro, Electron - UK - (1981-1994)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\bbcmicro^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .ssd .dsd .ad .img^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\BeebEm\BeebEm.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll bbcb -cass OR -flop "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\bbcmicro\ bbcb -cass OR -flop "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>bbcmicro^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>bbcmicro^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>electron^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>crvision^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - VTech CreatiVision - Europe - (1982-1986)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\crvision^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\crvision\ crvision -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>crvision^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>creativision^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>crvision^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>macintosh^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Apple Macintosh, OS 7.5.2 thru 9.0.4^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\macintosh^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .dsk .img .rom^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo ^<!-- START:  THIS  IS  WORK  IN  PROGRESS  --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\SheepShaver\sheepshaver.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\BasiliskII\basiliskii.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>odyssey2^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Magnavox Odyssey 2, Videopac, Videopac+ - (1978-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\odyssey2^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\o2em_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>odyssey2^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>odyssey2^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>sc-3000^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Sega SC-3000 - Japan - (1983-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\sc-3000^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .sg^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>sc-3000^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>sc-3000^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>svi318^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - SVI SpectraVideo 318 - (1983-1988)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\svi318^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bas .bin .col .com .ddp .dsk .img .lbr .rom .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\bluemsx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>svi318^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>svi318^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>ti99_4a^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Texas Inst. TI-99/4A - (1981-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\ti99_4a^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.zip .bin^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\ti99_4a\ ti99_4a -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Classic99\classic99.exe -rom "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>ti99_4a^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>ti99^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>ti99_4a^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>vic20^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Commodore VIC-20 - (1980-1985)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\vic20^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .crt .d64 .g64 .t64 .tap .x64 .zip .prg^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\vice_xvic_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\WinVICE\x64.exe -fullscreen "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>vic20^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>x1^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Sharp X1 - Japan - (1982-1988)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\x1^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .d88 .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\x1_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath %cusromdir%\x1\ x1 -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll x1 -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>x1^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>x1^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>x68000^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Sharp X68000 - Japan - (1987-1993)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\x68000^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .dim .m3u .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\px68k_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>x68000^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>x68000^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>zx81^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Sinclair Z81 - UK - (1981-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\zx81^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .sh .sna .szx .z80 .tap .tzx .gz .udi .mgt .img .trd .scl .dsk .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\81_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>zx81^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>zx81^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>dosbox^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Specialty - DOSBox - (2002)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\dosbox^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.exe^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\dosbox_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>windows^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Specialty - Windows - (2002)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\windows^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.exe^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\zzz_windows_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>snes-msu1^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Specialty - Super NES - MSU-1 (May 2012)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\snes-msu1^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.msu .sfc^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\snes9x_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>msu1^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>snesmsu1^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>uzebox^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Specialty -  Uzebox - (2007)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>%cusromdir%\uzebox^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .uze .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\uzem_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>uzebox^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>uzebox^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:::                                                                                            :::
:::   End of  '^<path^>%cusromdir%\...'  for ROMS path  in es_systems.cfg                     :::
:::                                                                                            :::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
IF EXIST "%tempDir%\BrandNewCus" GOTO writeRomDir
GOTO completed
::==============================================
::==============================================
...
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:::                                                                                               :::
:::   Generates  '^<path^>\PATH\TO\ROM\FOLDER\...'  for ROMS path  in es_systems.cfg                     :::
:::                                                                                               :::
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
echo ^<?xml version="1.0"?^> > "%esDir%\.emulationstation\es_systems.cfg"
echo ^<systemList^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>mame-libretro^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - MAME Libretro - latest^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\mame-libretro^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\mame-libretro\ "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>mame-libretro^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>mame^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>arcade^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>mame-libretro^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>fbneo-libretro^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - FB Neo Libretro - latest^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\fbneo-libretro^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .fba .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\fbneo_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\fbneo\fbneo.exe -rompath \PATH\TO\ROM\FOLDER\fbneo-libretro\ "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>fbneo-libretro^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>fbneo^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>arcade^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>fbneo-libretro^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>daphne^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - Hypseus - LaserDisc Games (Daphne/Singe)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\daphne^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.daphne^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Hypseus-Singe\hypseuse.exe "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>atomiswave^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - Sammy AtomisWave^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\atomiswave^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.cdi .chd .gdi .lst .zip .7z^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\flycast_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>atomiswave^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>atomiswave^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>hikaru^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - Sega Hikaru^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\hikaru-demul^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.7z .zip^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Demul\demul.exe -run=hikaru -rom="%%BASENAME%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>vector-games^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcade - Vector Games^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\vector-games^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\vector-games\ "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>vector-games^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>vector^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>mame^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>arcade^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>atari2600^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Atari 2600 - (1977-1992)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\atari2600^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .a26 .bin .gz .rom .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\stella_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\stella2014_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>atari2600^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>atari7800^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Atari 7800 ProSystem - (1986-1992)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\atari7800^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .a78 .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\prosystem_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>atari7800^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>atari7800^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>channelf^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Channel F - (1976-1983)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\channelf^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\freechaf_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\channelf\ channelf -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll channelf -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>channelf^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>channelf^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>gx4000^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GX4000 - Europe - (1990-1991)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\gx4000^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .cpr .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\gx4000\ gx4000 -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\cap32_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gx4000^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gx4000^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>mastersystem^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Master System - (1986-1992)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\mastersystem^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .sms .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>mastersystem^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>mastersystem^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>megadrive^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Mega Drive Genesis - (1989-1997)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\megadrive^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .gen .md .sg .smd .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>megadrive^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>genesis^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>pcengine^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PC Engine TurboGrafx 16 - (1989-1994)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\pcengine^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .pce .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_pce_fast_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_pce_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pcengine^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>pv1000^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PV-1000 - Japan - (1983-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\pv1000^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\pv1000\ pv1000 -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pv1000^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>pv1000^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>sg1000^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>SG-1000 - Japan - (1983-1985)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\sg1000^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .sg .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>sg1000^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>sg-1000^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>snes^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Super NES - (1991-1999)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\snes^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .bs .fig .mgd .sfc .smc .swc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\snes9x_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\snes9x2010_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>snes^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>supergrafx^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>SuperGrafx - Japan - (1989-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\supergrafx^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .cue .chd .pce .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_pce_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_supergrafx_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>supergrafx^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>supracan^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Super A`can - Taiwan - (1995)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\supracan^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\supracan\ supracan -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>supracan^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>supracan^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>super-acan^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>arcadia^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Arcadia 2001 - (1982-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\arcadia^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\arcadia\ arcadia -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>arcadia^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>arcadia^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>astrocde^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Astrocade - (1978-1983)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\astrocade^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\astrocde\ astrocde -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>astrocade^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>astrocade^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>astrocde^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>atari5200^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Atari 5200 - (1982-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\atari5200^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .a52 .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\atari800_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>atari5200^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>atari5200^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>colecovision^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>ColecoVision - (1982-1985)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\colecovision^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .col .rom .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\bluemsx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>colecovision^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>colecovision^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>intellivision^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Intellivision - (1979-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\intellivision^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .int .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\freeintv_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>intellivision^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>intellivision^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>intellivision-jzintv^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Intellivision - jzInTV - (1979-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\intellivision-jzintv^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .int .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\jzIntv\bin\jzIntv.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>intellivision-jzintv^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>intellivision-jzintv^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>intellivision-voice^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>IntelliVoice - Intellivision - (1982-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\intellivision-voice^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .int .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\jzIntv\bin\jzIntv.exe -z720x480 "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>intellivision-voice^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>intellivision-voice^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>intellivision-ecs^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>ECS Computer Module - Intellivision - (1983-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\intellivision-ecs^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .int .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\jzIntv\bin\jzIntv.exe -z720x480 "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>intellivision-ecs^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>intellivision-ecs^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>jaguar^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Atari Jaguar - (1993-1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\jaguar^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .j64 .jag .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\virtualjaguar_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>jaguar^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>atarijaguar^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>scv^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Super Cassette Vision - Japan - (1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\scv^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\scv\ scv -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>scv^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>scv^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>supercassettevision^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>studio2^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>RCA Studio II - (1977-1978)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\studio2^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .st2 .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\studio2\ studio2 -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>studio2^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>studio2^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>rca-studio-ii^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>atari2600-supercharger^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Atari 2600 - Starpath Supercharger - (1982-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\atari2600-supercharger^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .a26 .bin .gz .rom .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\stella_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\stella2014_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>atari2600-supercharger^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>fds^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Famicom Disk System - Japan - (1986-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\fds^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .fds .nes .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\fceumm_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>fds^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>fds^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>jaguarcd^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Atari Jaguar CD - (1995-1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\jaguarcd^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .chd .cue .iso .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\virtualjaguar_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>satellaview^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Satellaview - Japan - (1995-2000)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\satellaview^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bs .sfc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\snes9x_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>Satellaview^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>satellaview^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>sega32x^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Sega 32X - (1994-1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\sega32x^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .32x .bin .md .smd .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\picodrive_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>sega32x^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>sega32x^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>sufami^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Sufami Turbo - Japan - (1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\sufami^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .sfc .st .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\snes9x_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>sufami^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>sufami^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>supergb^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Super Game Boy - (1994)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\supergb^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .gb .gbc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mgba_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>supergb^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>sgb^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>3do^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>3DO - (1993-1997)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\3do^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .iso^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\opera_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>3do^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>3do^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>amigacd32^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Amiga CD32 - Europe - (1993-1994)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\amigacd32^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cue .iso .lha^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\puae_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<![CDATA[ ^<command^>%systemsDir%\FS-UAE\System\FS-UAE\Windows\x86-64\fs-uae.exe --amiga-model=CD32 --joystick-port-0-mode="cd32 gamepad" --fullscreen=1 --cdrom-drive-0="%%ROM_RAW%%"^</command^> ]]^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>amigacd32^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>amigacdtv^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Commodore CDTV - (1991)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\amigacdtv^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cue^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\puae_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<![CDATA[ ^<command^>%systemsDir%\FS-UAE\System\FS-UAE\Windows\x86-64\fs-uae.exe --amiga-model=CDTV --joystick-port-0-mode=joystick --fullscreen=1 --cdrom-drive-0="%%ROM_RAW%%"^</command^> ]]^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>amigacdtv^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>cdimono1^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Philips CD-i - (1990-1998)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\cdimono1^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\cdimono1\ cdimono1 -skip_gameinfo "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>cdimono1^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>philipscdi^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>cdimono1^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>dreamcast^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Dreamcast - (1999-2001)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\dreamcast^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.cdi .chd .gdi .zip .7z^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\flycast_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>dreamcast^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>dreamcast^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>gamecube^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameCube - (2001-2007)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\gamecube^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .gcz .iso .rpx .rvz .wad .wbfs^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\dolphin_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Dolphin\Dolphin.exe -e "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Dolphin-dev\Dolphin.exe -e "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>pcenginecd^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PC Engine TurboGrafx CD - (1989-1994)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\pcenginecd^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .cue .chd .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_pce_fast_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_pce_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pcenginecd^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>pcfx^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PC-FX - Japan - (1994-1998)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\pcfx^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .chd .cue .img .iso .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_pcfx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pcfx^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>pcfx^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>ps2^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PlayStation 2 - (2000-2013)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\ps2^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .gz .img .iso^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\pcsx2_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\play_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<![CDATA[ ^<command^>%systemsDir%\PCSX2\pcsx2.exe "%%ROM_RAW%%" --fullscreen^</command^> ]]^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>ps3^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PlayStation 3 - (2006-2017)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\ps3^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>ps3^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>ps3^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>psx^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PlayStation - (1995-2006)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\psx^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cue .iso^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_psx_hw_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>psx^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>psx^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>saturn^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Saturn - (1995-2000)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\saturn^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cue .iso .mdf^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_saturn_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\kronos_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>saturn^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>segacd^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Sega CD - (1992-1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\segacd^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cue .iso^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>segacd^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>segacd^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>wii^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Wii - (2006-2013)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\wii^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .gcz .iso .rpx .rvz .wad .wbfs^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\dolphin_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Dolphin\Dolphin.exe -e "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Dolphin-dev\Dolphin.exe -e "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>wiiu^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Wii U - (2012-2017)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\wiiu^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.iso .rpx .wud .wux^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\cemu\Cemu.exe -f -g "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>xbox^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>XBOX - (2001-2009)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\xbox^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.iso^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\Xemu\xemu.exe -full-screen -dvd_path "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>xbox360^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>XBOX 360 - (2005-2016)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\xbox360^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.iso^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\Xenia\xenia.exe --vsync=false "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>3ds^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>3DS - (2011-2020)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\3ds^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .3ds .cia .cxi .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\citra_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>3ds^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>3ds^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>advision^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Adventure Vision - (1982-1983)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\advision^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath  \PATH\TO\ROM\FOLDER\advision\ advision -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg" 
echo     ^<platform^>advision^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>advision^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>adventurevision^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>gamecom^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Game.com - (1997-2000)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\gamecom^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .tgc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\gamecom\ gamecom -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gamecom^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gamecom^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>tigergame^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>gamegear^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Game Gear - (1991-2000)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\gamegear^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .gg .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gamegear^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gamegear^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>gb^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Game Boy - (1989-2003)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\gb^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .gb .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\gambatte_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gb^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gb^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>gbc^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Game Boy Color - (1998-2003)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\gbc^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .gbc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\gambatte_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gbc^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gbc^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>gba^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Game Boy Advance - (2001-2010)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\gba^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .gba .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mgba_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gba^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gba^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>gameandwatch^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Game ^& Watch - (1980-1991)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\gameandwatch^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.mgw^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\gw_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gameandwatch^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gameandwatch^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>gmaster^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Game Master - Europe - (1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\gmaster^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\gmaster\ gmaster -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gmaster^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gmaster^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>gp32^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Gamepark GP32 - Korea - (2001-2005)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\gp32^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .smc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\gp32\ gp32 -memc "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\GeePee32\geepee32.exe "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>gp32^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>gp32^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>lynx^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Atari Lynx - (1989-1995)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\lynx^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .lnx .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_lynx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\handy_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>lynx^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>megaduck^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Mega Duck - (1993)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\megaduck^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\megaduck\ gb -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>megaduck^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>megaduck^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>pokemini^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Pokemon Mini - (2001-2002)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\pokemini^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .min .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\pokemonmini_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pokemini^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>pokemini^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>psp^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PSP - (2005-2014)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\psp^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cso .iso .pbp^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\ppsspp_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>psp^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>psp^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>pspminis^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PSP Go minis - (2009-2013)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\pspminis^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.chd .cso .iso .pbp^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\ppsspp_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pspminis^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>pspgo^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>psvita^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>PS Vita - (2011-2019)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\psvita^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.vpk^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\Vita3k\vita3k.exe --vpk-path "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>psvita^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>psvita^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>supervision^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Supervision - (1992)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\supervision^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .sv .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\potator_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\supervision\ svision -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>svision^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>supervision^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>svision^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>switch^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Switch - (2017-)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\switch^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.nsp .xci^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\Yuzu\yuzu.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>vectrex^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Vectrex - (1982-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\vectrex^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .gam .vec .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\vecx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>vectrex^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>vectrex^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>virtualboy^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Virtual Boy - (1995-1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\virtualboy^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .vb .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_vb_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>virtualboy^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>virtualboy^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>wswan^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>WonderSwan - Japan - (1999-2003)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\wswan^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .ws .wsc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_wswan_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>wswan^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>wonderswan^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>wswanc^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>WonderSwan Color - Japan - (2000-2003)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\wswanc^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .ws .wsc .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mednafen_wswan_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>wswanc^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>wonderswancolor^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>lowresnx^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - LowRes NX - libretro - (2016)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\lowresnx^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.nx .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\lowresnx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>lowresnx^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>lowresnx^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>lutro^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - Lutro - libretro - (2016)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\lutro^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.lutro^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\lutro_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>lutro^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>lutro^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>openbor^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - OpenBOR - libretro - (2016)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\openbor^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.pak^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\OpenBOR\openbor-start.bat "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>pico8^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - PICO-8 - libretro - (2016)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\pico8^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.sh .p8 .png .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\pico8_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>pico8^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>pico8^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>ports^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - Game Ports for RetroArch - libretro ^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\ports^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>ports^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>ports^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>scummvm^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - ScummVM - (2001)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\scummvm^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.exe^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\scummvm_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>solarus^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - Solarus (2019)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\solarus^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.bat^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>"%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.solarus .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\SolarusPak\solarus\solarus-run.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>tic80^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>GameEngine - TIC-80 tiny computer - (2017)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\tic80^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .tic .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\tic80_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>tic80^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>tic80^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>adam^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Coleco ADAM - (1983-1985)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\adam^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .col .rom .ddp .dsk .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\bluemsx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>adam^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>adam^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>amiga^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Commodore Amiga - (1985-1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\amiga^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.adf .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\puae_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>amiga^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>amiga^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>amstradcpc^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Amstrad CPC - Europe - (1984-1990)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\amstradcpc^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .cdt .cpc .dsk^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\cap32_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>amstradcpc^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>amstradcpc^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>apple2^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Apple II - (1977-1979)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\apple2^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .dsk^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\AppleWin\Applewin.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>apple2^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>apple2^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>aquarius^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Mattel Aquarius - (1983)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\aquarius^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .bin^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\aquarius\ aquarius -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>aquarius^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>aquarius^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>atari800^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Atari 800 - (1979-1992)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\atari800^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .bas .bin .car .com .xex .atr .xfd .dcm .atr.gz .xfd.gz^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\atari800_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>atari800^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>atari800^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>atarist^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Atari ST - (1985-1993)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\atarist^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .st .stx .img .rom .raw .ipf .ctr^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\hatari_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Hatari\Hatari.exe "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Hatari-latest\Hatari.exe "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>bbcmicro^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Acorn BBC Micro, Electron - UK - (1981-1994)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\bbcmicro^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .ssd .dsd .ad .img^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\BeebEm\BeebEm.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll bbcb -cass OR -flop "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\bbcmicro\ bbcb -cass OR -flop "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>bbcmicro^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>bbcmicro^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>electron^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>c64^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Commodore 64 - (1982-1994)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\c64^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .crt .d64 .g64 .t64 .tap .x64 .zip .prg^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\vice_x64_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\WinVICE\x64.exe -fullscreen "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>c64^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>coco^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Tandy Color / Dragon 32 - (1980-1991)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\coco^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .cas .wav .bas .asc .dmk .jvc .os9 .dsk .vdk .rom .ccc .sna^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\XRoar\xroar.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>coco^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>coco^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>crvision^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - VTech CreatiVision - Europe - (1982-1986)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\crvision^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\crvision\ crvision -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>crvision^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>creativision^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>crvision^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>macintosh^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Apple Macintosh, OS 7.5.2 thru 9.0.4^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\macintosh^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .dsk .img .rom^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo ^<!-- START:  THIS  IS  WORK  IN  PROGRESS  --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\SheepShaver\sheepshaver.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%systemsDir%\BasiliskII\basiliskii.exe "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>msx^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Microsoft MSX, MSX2, MSX2+, MSX turboR - (1983-1996)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\msx^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .rom .mx1 .mx2 .col .dsk .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\bluemsx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>msx^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>msx^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>odyssey2^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Magnavox Odyssey 2, Videopac, Videopac+ - (1978-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\odyssey2^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\o2em_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>odyssey2^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>odyssey2^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>sc-3000^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Sega SC-3000 - Japan - (1983-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\sc-3000^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .zip .sg^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>sc-3000^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>sc-3000^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>svi318^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - SVI SpectraVideo 318 - (1983-1988)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\svi318^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .bas .bin .col .com .ddp .dsk .img .lbr .rom .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\bluemsx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>svi318^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>svi318^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>ti99_4a^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Texas Inst. TI-99/4A - (1981-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\ti99_4a^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.zip .bin^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\ti99_4a\ ti99_4a -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\Classic99\classic99.exe -rom "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>ti99_4a^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>ti99^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>ti99_4a^</theme^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>vic20^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Commodore VIC-20 - (1980-1985)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\vic20^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .crt .d64 .g64 .t64 .tap .x64 .zip .prg^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\vice_xvic_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\WinVICE\x64.exe -fullscreen "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>vic20^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>x1^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Sharp X1 - Japan - (1982-1988)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\x1^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .d88 .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\x1_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%systemsDir%\mame\mame.exe -rompath \PATH\TO\ROM\FOLDER\x1\ x1 -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\mame_libretro.dll x1 -cart "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>x1^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>x1^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>x68000^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Sharp X68000 - Japan - (1987-1993)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\x68000^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .dim .m3u .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\px68k_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>x68000^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>x68000^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>zx81^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Sinclair Z81 - UK - (1981-1984)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\zx81^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .sh .sna .szx .z80 .tap .tzx .gz .udi .mgt .img .trd .scl .dsk .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\81_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>zx81^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>zx81^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>zxspectrum^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Computer - Sinclair ZX Spectrum - UK - (1982-1992)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\zxspectrum^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .sh .sna .szx .z80 .tap .tzx .gz .udi .mgt .img .trd .scl .dsk .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\fuse_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>zxspectrum^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>zxspectrum^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>dosbox^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Specialty - DOSBox - (2002)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\dosbox^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.exe^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\dosbox_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>windows^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Specialty - Windows - (2002)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\windows^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.exe^</extension^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\zzz_windows_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>snes-msu1^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Specialty - Super NES - MSU-1 (May 2012)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\snes-msu1^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.msu .sfc^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\snes9x_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>msu1^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>snesmsu1^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
echo     ^<name^>uzebox^</name^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<fullname^>Specialty -  Uzebox - (2007)^</fullname^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<path^>\PATH\TO\ROM\FOLDER\uzebox^</path^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.7z .uze .zip^</extension^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<command^>%RADir%\retroarch.exe -L %RADir%\cores\uzem_libretro.dll "%%ROM_RAW%%"^</command^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<platform^>uzebox^</platform^> >> "%esDir%\.emulationstation\es_systems.cfg"
echo     ^<theme^>uzebox^</theme^> >> "%esDir%\.emulationstation\es_systems.cfg"
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:::                                                                                            :::
:::   End of  '^<path^>\PATH\TO\ROM\FOLDER\...'  for ROMS path  in es_systems.cfg              :::
:::                                                                                            :::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
ping 127.0.0.1 -n 3 >NUL
%toolsDir%\7za\7za.exe x "%tempDir%\RetroArch_x64.7z" -o"%rp4winDir%" >NUL
ping 127.0.0.1 -n 3 >NUL
%toolsDir%\7za\7za.exe x "%tempDir%\RetroArch_x64_cores.7z" -o"%rp4winDir%" >NUL
ping 127.0.0.1 -n 3 >NUL
...
ping 127.0.0.1 -n 3 >NUL
%toolsDir%\7za\7za.exe x "%tempDir%\RetroArch_x86.7z" -o"%rp4winDir%" >NUL
ping 127.0.0.1 -n 3 >NUL
%toolsDir%\7za\7za.exe x "%tempDir%\RetroArch_x86_cores.7z" -o"%rp4winDir%" >NUL
ping 127.0.0.1 -n 3 >NUL
...
%toolsDir%\7za\7za.exe x "%tempDir%\RetroArch_x64_cores.7z" -o"%tempDir%" >NUL
ping 127.0.0.1 -n 3 >NUL
...
IF NOT EXIST %RADir%\cores\ MKDIR "%RADir%\cores"
%toolsDir%\7za\7za.exe x "%tempDir%\RetroArch_x86_cores.7z" -o"%tempDir%" >NUL
ping 127.0.0.1 -n 3 >NUL
...
%toolsDir%\7za\7za.exe x "%tempDir%\AppleWin.zip" -o"%systemsDir%\AppleWin" >NUL
echo =
echo =
echo =
echo =
...
%toolsDir%\7za\7za.exe x "%tempDir%\BeebEm.zip" -o"%systemsDir%" >NUL
echo =
echo =
echo =
echo =
...
%toolsDir%\7za\7za.exe x "%tempDir%\BlueMSX.zip" -o"%systemsDir%\BlueMSX" >NUL
echo =
echo =
echo =
echo =
...
%toolsDir%\7za\7za.exe x "%tempDir%\cemu.zip" -o"%systemsDir%" >NUL
ping 127.0.0.1 -n 2 >NUL
SET currentDir=%CD%
CD /D "%systemsDir%"
...
%toolsDir%\7za\7za.exe x "%tempDir%\citra.7z" -o"%systemsDir%" >NUL
ping 127.0.0.1 -n 2 >NUL
SET currentDir=%CD%
CD /D "%systemsDir%"
REN "%systemsDir%\nightly-mingw" Citra
...
%toolsDir%\7za\7za.exe x "%tempDir%\ColEm.zip" -o"%systemsDir%\ColEm" >NUL
echo =
echo =
echo =
echo =
...
%toolsDir%\7za\7za.exe x "%tempDir%\classic99.zip" -o"%systemsDir%" >NUL
ping 127.0.0.1 -n 2 >NUL
SET currentDir=%CD%
CD /D "%systemsDir%"
...
%toolsDir%\7za\7za.exe x "%tempDir%\Cxbx-Reloaded.zip" -o"%systemsDir%\Cxbx-Reloaded" >NUL
echo =
echo =
echo =
echo =
...
%toolsDir%\7za\7za.exe x "%tempDir%\Daphne.zip" -o"%systemsDir%\Daphne" >NUL
echo =
echo =
echo =
echo =
...
%toolsDir%\7za\7za.exe x "%tempDir%\Dolphin.7z" -o"%systemsDir%" >NUL
ping 127.0.0.1 -n 2 >NUL
SET currentDir=%CD%
CD /D "%systemsDir%"
...
%toolsDir%\7za\7za.exe x "%tempDir%\Hatari32.zip" -o"%systemsDir%" >NUL
ping 127.0.0.1 -n 2 >NUL
SET currentDir=%CD%
CD /D "%systemsDir%"
...
%toolsDir%\7za\7za.exe x "%tempDir%\Hatari64.zip" -o"%systemsDir%" >NUL
ping 127.0.0.1 -n 2 >NUL
SET currentDir=%CD%
CD /D "%systemsDir%"
...
%toolsDir%\7za\7za.exe x "%tempDir%\jzintv.zip" -o"%systemsDir%" >NUL
ping 127.0.0.1 -n 2 >NUL
SET currentDir=%CD%
CD /D "%systemsDir%"
...
%toolsDir%\7za\7za.exe x "%tempDir%\Mame64.exe" -o"%systemsDir%\Mame" >NUL
echo =
echo =
echo =
echo =
...
%toolsDir%\7za\7za.exe x "%tempDir%\OpenBOR.7z" -o"%tempDir%" >NUL
...
%toolsDir%\7za\7za.exe x "%tempDir%\PCSX2.7z" -o"%systemsDir%" >NUL
ping 127.0.0.1 -n 2 >NUL
SET currentDir=%CD%
CD /D "%systemsDir%"
...
%toolsDir%\7za\7za.exe x "%tempDir%\ppsspp.zip" -o"%systemsDir%\Ppsspp" >NUL
echo =
echo =
echo =
echo =
...
%toolsDir%\7za\7za.exe x "%tempDir%\rpcs3.7z" -o"%systemsDir%\Rpcs3" >NUL
echo =
echo =
echo =
echo =
...
%toolsDir%\7za\7za.exe x "%tempDir%\vita3k.zip" -o"%systemsDir%\Vita3k" >NUL
echo =
echo =
echo =
echo =
...
%toolsDir%\7za\7za.exe x "%tempDir%\xemu.zip" -o"%systemsDir%\Xemu" >NUL
echo =
echo =
echo =
echo =
...
%toolsDir%\7za\7za.exe x "%tempDir%\xenia.zip" -o"%systemsDir%\Xenia" >NUL
echo =
echo =
echo =
echo =
...
%toolsDir%\7za\7za.exe x "%tempDir%\XRoar32.zip" -o"%systemsDir%" >NUL
ping 127.0.0.1 -n 2 >NUL
SET currentDir=%CD%
CD /D "%systemsDir%"
...
%toolsDir%\7za\7za.exe x "%tempDir%\XRoar64.zip" -o"%systemsDir%" >NUL
ping 127.0.0.1 -n 2 >NUL
SET currentDir=%CD%
CD /D "%systemsDir%"
...
%toolsDir%\7za\7za.exe x "%tempDir%\yuzu.zip" -o"%systemsDir%" >NUL
ping 127.0.0.1 -n 2 >NUL
SET currentDir=%CD%
CD /D "%systemsDir%"
...
%toolsDir%\7za\7za.exe x "%tempDir%\VICE32.zip" -o"%systemsDir%" >NUL
ping 127.0.0.1 -n 2 >NUL
SET currentDir=%CD%
CD /D "%systemsDir%"
...
%toolsDir%\7za\7za.exe x "%tempDir%\VICE64.zip" -o"%systemsDir%" >NUL
ping 127.0.0.1 -n 2 >NUL
SET currentDir=%CD%
CD /D "%systemsDir%"
...
CLS
mkdir %romsDir%\mame-libretro
mkdir %romsDir%\fbneo-libretro
mkdir %romsDir%\daphne
mkdir %romsDir%\atomiswave
mkdir %romsDir%\hikaru-demul
mkdir %romsDir%\naomi
mkdir %romsDir%\vector-games

mkdir %romsDir%\atari2600
mkdir %romsDir%\atari7800
mkdir %romsDir%\channelf
mkdir %romsDir%\gx4000
...
mkdir %romsDir%\pv1000
mkdir %romsDir%\sg1000
mkdir %romsDir%\snes
mkdir %romsDir%\supergrafx
mkdir %romsDir%\supracan

mkdir %romsDir%\arcadia
mkdir %romsDir%\astrocade
mkdir %romsDir%\atari5200
mkdir %romsDir%\colecovision
mkdir %romsDir%\intellivision
mkdir %romsDir%\intellivision-jzintv
mkdir %romsDir%\intellivision-voice
mkdir %romsDir%\intellivision-ecs
mkdir %romsDir%\jaguar
mkdir %romsDir%\scv
mkdir %romsDir%\studio2

mkdir %romsDir%\atari2600-supercharger
mkdir %romsDir%\fds
mkdir %romsDir%\jaguarcd
mkdir %romsDir%\n64dd
mkdir %romsDir%\satellaview
mkdir %romsDir%\sega32x
mkdir %romsDir%\sufami
mkdir %romsDir%\supergb

mkdir %romsDir%\3do
mkdir %romsDir%\amigacd32
mkdir %romsDir%\amigacdtv
mkdir %romsDir%\cdimono1
mkdir %romsDir%\dreamcast
mkdir %romsDir%\gamecube
mkdir %romsDir%\neogeocd
mkdir %romsDir%\pcenginecd
mkdir %romsDir%\pcfx
mkdir %romsDir%\ps2
mkdir %romsDir%\ps3
mkdir %romsDir%\psx
...
mkdir %romsDir%\wiiu
mkdir %romsDir%\xbox
mkdir %romsDir%\xbox360

mkdir %romsDir%\3ds
mkdir %romsDir%\advision
mkdir %romsDir%\gameandwatch
mkdir %romsDir%\gamecom
mkdir %romsDir%\gamegear
mkdir %romsDir%\gb
mkdir %romsDir%\gba
mkdir %romsDir%\gbc
mkdir %romsDir%\gmaster
mkdir %romsDir%\gp32
mkdir %romsDir%\lynx
mkdir %romsDir%\megaduck
mkdir %romsDir%\nds
mkdir %romsDir%\ngp
mkdir %romsDir%\ngpc
mkdir %romsDir%\pokemini
mkdir %romsDir%\psp
mkdir %romsDir%\pspminis
mkdir %romsDir%\psvita
mkdir %romsDir%\supervision
mkdir %romsDir%\switch
mkdir %romsDir%\vectrex
mkdir %romsDir%\virtualboy
mkdir %romsDir%\wswan
mkdir %romsDir%\wswanc

mkdir %romsDir%\lowresnx
mkdir %romsDir%\lutro
mkdir %romsDir%\openbor
mkdir %romsDir%\pico8
mkdir %romsDir%\ports
mkdir %romsDir%\ports\cannonball-outrun
mkdir %romsDir%\ports\cavestory
mkdir %romsDir%\ports\doom
mkdir %romsDir%\ports\quake
mkdir %romsDir%\ports\rick-dangerous
mkdir %romsDir%\scummvm
mkdir %romsDir%\solarus
mkdir %romsDir%\tic80
...
mkdir %romsDir%\aquarius
mkdir %romsDir%\atari800
mkdir %romsDir%\atarist
mkdir %romsDir%\bbcmicro
mkdir %romsDir%\bbcmicro\bbcmicro
mkdir %romsDir%\bbcmicro\electron
mkdir %romsDir%\c64
mkdir %romsDir%\coco
mkdir %romsDir%\coco\coco
mkdir %romsDir%\coco\dragon32
mkdir %romsDir%\crvision
mkdir %romsDir%\macintosh
mkdir %romsDir%\msx
mkdir %romsDir%\msx\msx1
mkdir %romsDir%\msx\msx2
mkdir %romsDir%\msx\msx2plus
mkdir %romsDir%\msx\msx-turbo-r
mkdir %romsDir%\odyssey2
mkdir %romsDir%\sc-3000
mkdir %romsDir%\svi318
mkdir %romsDir%\ti99_4a
mkdir %romsDir%\vic20
mkdir %romsDir%\videopac-plus
mkdir %romsDir%\x1
mkdir %romsDir%\x68000
mkdir %romsDir%\zx81
mkdir %romsDir%\zxspectrum

mkdir %romsDir%\dosbox
mkdir %romsDir%\windows
mkdir %romsDir%\snes-msu1
mkdir %romsDir%\uzebox
:: Opens file location
START %romsDir%
...
SET /P cusromdir="=->  Enter Path for ROM Folder: "
IF /I "%cusromdir%" EQU "Q" GOTO Quit
IF /I "%cusromdir%" EQU "%romsDir%" GOTO InvalidInput
IF /I "%cusromdir%" EQU "%romsDir%\" GOTO InvalidInput
...
echo %toolsDir%\git\bin\git.exe clone --quiet --depth=1 https://github.com/ironwolf86/RP4Win.git %tempDir%\Script >>"%toolsDir%\Updater.bat"
echo ping 127.0.0.1 -n 3 ^>nul >>"%toolsDir%\Updater.bat"
echo XCOPY "%tempDir%\Script\RP4Win.bat" %rp4winDir%\ >>"%toolsDir%\Updater.bat"
echo RMDIR "%tempDir%\Script" /S /Q >>"%toolsDir%\Updater.bat"
echo TIMEOUT /T 1 >>"%toolsDir%\Updater.bat"
echo START /MAX cmd.exe /c "%rp4winDir%\RP4Win.bat" max ^& EXIT >>"%toolsDir%\Updater.bat"
TIMEOUT /T 5
START /MAX cmd.exe /c "%toolsDir%\Updater.bat" & EXIT
GOTO Main
::==============================================
::=================================================================================================================================================================================================================================================================================================================
::=================================================================================================================================================================================================================================================================================================================
...
%toolsDir%\7za\7za.exe x "%tempDir%\scraperx86.zip" -o"%toolsDir%" >NUL
GOTO ScraperMenu
...
%toolsDir%\7za\7za.exe x "%tempDir%\scraperx64.zip" -o"%toolsDir%" >NUL
GOTO ScraperMenu
